...
<body>
    ...
    <section class="main" id="home">
        ...
        <button type="button" onclick="location.href='login.php'"
            style="background: #222; color: white; border: 0; margin-left: 9rem; margin-top: 5rem; height: 50px; font-size: 1.2rem; width: 200px; cursor: pointer; border-radius: 25px;">BOOK
            NOW</button>
    ...
    <section class="about" id="about">
        <div class="about_con">
            ...
            <h1>MISSION</h1>
            <p>To provide the best medical care and advanced diagnostic services for patients of North Caloocan that is
                generally cost-effective and affordable. Equipped with highly motivated, professional, and competent
                personnel, committed to uphold human dignity, respect for life and right to health.</p>
        ...
        <div class="d-flex">
            ...
            <div class="service_con mt-5">
                <div class="service_box">
                    ...
                    <div class="details">OB-GYNE SONOLOGIST</div>
                </div>
            </div>
            ...
            <div class="service_con mt-5">
                <div class="service_box">
                    ...
                    <div class="details">PACKAGES</div>
                </div>
            </div>
            ...
            <div class="service_con mt-5">
                <div class="service_box">
                    ...
                    <div class="details">SWAB and VACCINE</div>
                </div>
            </div>
            ...
            <div class="service_con mt-5">
                <div class="service_box">
                    ...
                    <div class="details">GENERAL ULTRASOUND</div>
                </div>
            </div>
        </div>
