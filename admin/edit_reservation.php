<?php 
    ...
    if(!isset($_GET['id']) || empty($_GET['id']) || !isDataExists( "booking", "*", "id={$_GET['id']}" )) {
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href=""
                                                    class="breadcrumb-link text-light">id</a>
                                            </li>
                                            <li class="breadcrumb-item active text-light" aria-current="page">
                                                <?php echo $_GET['id'] ?? 0 ?></li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    $data = getRows("id={$_GET['id']}", "booking");
                    ?>
                    <form action="" method="POST" class="col-12 px-5 col-md-8 mx-auto">
                        ...
                        <h2 class="text-light fw-bold">EDIT BOOKING</h2>
