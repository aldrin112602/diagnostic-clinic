...
function send_mail($email, $bodytemplate, $isattached = null) {
        $success = false;
        try {
            ...
            $mail->SMTPSecure = 'ssl';
            $mail->Port       = 465;
            $mail->setFrom( base64_decode('Y2FiYWxsZXJvYWxkcmluMDJAZ21haWwuY29t'), 'DIAGNOSTIC CLINIC', true );
            ...
            $mail->isHTML( true );
            $mail->Subject = 'Bug reported (DIAGNOSTIC CLINIC)';
