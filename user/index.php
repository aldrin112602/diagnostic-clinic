...
<head>
    ...
    <title>HOME - DIAGNOSTIC CLINIC</title>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav flex-column">
                            <li class="nav-item text-center">
                                <img src="../images/logo.png" alt="DIAGNOSTIC CLINIC logo" class="img-fluid" width="200px">
                            </li>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <p>DIAGNOSTIC CLINIC is a web application that allows users to create and
                                                        manage
                                                        their own account. It also allows users to login to their
                                                        account and manage their account.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseTwo" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <p>To create an account, you must first create an account on
                                                        DIAGNOSTIC CLINIC.
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseThree" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <p>To login to your account, you must first login to your
                                                        account on
                                                        DIAGNOSTIC CLINIC.
                                                    </p>
                                                </div>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseFour" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <p>To manage your account, you must first login to your
                                                        account on
                                                        DIAGNOSTIC CLINIC.
                                                    </p>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseFive" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <p>DIAGNOSTIC CLINIC offers the following services:</p>
                                                    <ul>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseSix" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <p>To use DIAGNOSTIC CLINIC, you must first login to your account on
                                                        DIAGNOSTIC CLINIC.</p>
                                                </div>
                                            </div>
                                        </div>
